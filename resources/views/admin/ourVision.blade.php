                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="title_en"
                                            value="{{ $ourVision['title']['en'] }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label class="col-form-label">About us (description)</label>
                                        <textarea type="text" class="form-control" name="description_en" rows="4" required>{{ $ourVision['description']['en'] }} </textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="title_ar"
                                                value="{{ $ourVision['title']['ar'] }}" dir="rtl" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label class="col-form-label">من نحن (وصف مفصل)</label>
                                            <textarea type="text" class="form-control" name="description_ar" rows="4" dir="rtl" required>{{ $ourVision['description']['ar'] }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
