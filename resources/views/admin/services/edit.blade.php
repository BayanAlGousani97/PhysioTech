                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="name_en"
                                            value="{{ $serviceT['name']['en'] }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label class="col-form-label">Short description</label>
                                        <textarea type="text" class="form-control" name="short_description_en" rows="2" required>{{ $serviceT['short_description']['en'] }} </textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label class="col-form-label">Description</label>
                                        <textarea type="text" class="form-control" name="description_en" rows="5" required>{{ $serviceT['description']['en'] }} </textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <img id="frameEn" src="{{ $service->image_en }}" class="img-fluid" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="name_ar"
                                                value="{{ $serviceT['name']['ar'] }}" dir="rtl" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label class="col-form-label">نبذة مختصرة</label>
                                            <textarea type="text" class="form-control" name="short_description_ar" rows="2" dir="rtl" required>{{ $serviceT['short_description']['ar'] }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label class="col-form-label">وصف مفصل </label>
                                            <textarea type="text" class="form-control" name="description_ar" rows="5" dir="rtl" required>{{ $serviceT['description']['ar'] }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-5">
                                        ...
                                        <img id="frameAr" src="{{ $service->image_ar }}" class="img-fluid" />
                                    </div>
                            </div>
                        </div>
                    </div>
