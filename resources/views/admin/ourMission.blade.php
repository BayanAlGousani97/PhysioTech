                    ...
                    <div class="card shadow">
                        ...
                        <div class="collapse show" id="collapseCardEnglish">
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-12">
                                        <label class="col-form-label">Our mission (description)</label>
                                        <textarea type="text" class="form-control" name="description_en" rows="6" required>{{ $ourMissionTranslate['description']['en'] }} </textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <img id="frameEn" src="{{ $ourMission->image_en }}" class="img-fluid" />
                                    </div>
                                </div>
                        ...
                        <div class="collapse show" id="collapseCardHeaderArabic">
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-12">
                                            <label class="col-form-label">رسالتنا (وصف مفصل)</label>
                                            <textarea type="text" class="form-control" name="description_ar" rows="6" dir="rtl" required>{{ $ourMissionTranslate['description']['ar'] }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-5">
                                        ...
                                        <img id="frameAr" src="{{ $ourMission->image_ar }}" class="img-fluid" />
                                    </div>
